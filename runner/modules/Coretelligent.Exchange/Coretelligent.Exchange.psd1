@{
    ...
    FunctionsToExport = @('Connect-CtgExchange', 'Get-CtgMailboxSizeGB', 'Invoke-CtgExchangeOnboarding', 'Set-CtgMailboxRegional', 'Wait-CtgMailbox', 'Invoke-CtgExchangeOffboarding', 'Confirm-CtgExchange')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
