@{
    ...
    FunctionsToExport = @('Invoke-CtgADOnboarding', 'Invoke-CtgADOffboarding', 'Set-CtgADAttributes', 'Get-CtgMirrorGroups', 'Test-CtgCondition', 'Resolve-CtgOuPath', 'Confirm-CtgAD')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
