@{
    ...
    FunctionsToExport = @('Invoke-CtgADOnboarding', 'Invoke-CtgADOffboarding', 'Invoke-CtgADEmailWriteback', 'Confirm-CtgADEmailWriteback', 'Invoke-CtgADConsistencyCheck', 'Invoke-CtgADHardMatch', 'Set-CtgADAttributes', 'Get-CtgMirrorGroups', 'Test-CtgCondition', 'Resolve-CtgOuPath', 'Confirm-CtgAD')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
