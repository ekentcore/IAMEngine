@{
    ...
    FunctionsToExport = @('Connect-CtgSpanning', 'Invoke-CtgSpanningApi', 'Test-CtgSpanning404', 'Find-CtgSpanningUser', 'Set-CtgSpanningLicense', 'Invoke-CtgSpanningOnboarding', 'Invoke-CtgSpanningOffboarding', 'Confirm-CtgSpanning')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
