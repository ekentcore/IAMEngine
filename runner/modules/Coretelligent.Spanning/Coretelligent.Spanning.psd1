@{
    ...
    FunctionsToExport = @('Connect-CtgSpanning', 'Invoke-CtgSpanningApi', 'Test-CtgSpanning404', 'Test-CtgSpanningSeatError', 'Test-CtgSpanningLicensed', 'Test-CtgSpanningArchived', 'Find-CtgSpanningUser', 'Set-CtgSpanningLicense', 'Invoke-CtgSpanningOnboarding', 'Invoke-CtgSpanningOffboarding', 'Confirm-CtgSpanning')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
