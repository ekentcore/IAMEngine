@{
    ...
    FunctionsToExport = @('Connect-CtgM365', 'New-CtgCompliantPassword', 'Resolve-CtgSkuId', 'Set-CtgSeatAwareLicense', 'Invoke-CtgM365CloudMirror', 'Resolve-CtgM365Upn', 'Get-CtgM365UserDevices', 'Invoke-CtgM365Onboarding', 'Invoke-CtgM365Offboarding', 'Confirm-CtgM365', 'Invoke-CtgEntraTap', 'Invoke-CtgM365PasswordReset')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
