@{
    ...
    FunctionsToExport = @('Connect-CtgM365', 'New-CtgCompliantPassword', 'Resolve-CtgSkuId', 'Set-CtgSeatAwareLicense', 'Invoke-CtgM365CloudMirror', 'Invoke-CtgM365Onboarding', 'Invoke-CtgM365Offboarding', 'Confirm-CtgM365')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
