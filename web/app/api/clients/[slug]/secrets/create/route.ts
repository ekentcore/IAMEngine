...
export async function POST(req: Request, { params }: { params: { slug: string } }) {
  ...
  let body: { name?: unknown; values?: unknown; label?: unknown; folderId?: unknown };
  ...
  await recordAudit("secret.create", {
    user: g.user,
    clientId: client.id,
    detail: { name, fields: Object.keys(fields), externalId: result.id, templateId: tmpl.templateId },
  });
