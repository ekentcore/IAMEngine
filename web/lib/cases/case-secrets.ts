...
export const ALWAYS_ON_PREM_SYSTEMS = ["active-directory", "directory-sync", "ad-email-writeback", "ad-consistency-check", "ad-hard-match", "ad-password-reset", "ad-remove-user", "ad-correct-user"];
