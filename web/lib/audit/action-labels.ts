...
const EXPLICIT: Record<string, string> = {
  ...
  "agent.identity.set": "Agent Renamed / Re-scoped",
  "agent.priority.set": "Agent Priority Changed",
  "agent.enroll_token.create": "Agent Enroll Token Issued",
  ...
  "client.runbook.set": "Client Runbook Edited",
